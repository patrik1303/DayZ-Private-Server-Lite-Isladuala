DayZ Private Server Lite: Isladuala
===================================
...
-----------
 ...
 NOTE: The DayZ: Isladuala Client Files must be installed prior to installing this server pack.

 - **@dayzisladuala** - DayZ: Isladuala Client
...
--------
 ...
 NOTE: All vehicle spawns included in this server pack are the Official DayZ: Isladuala vehicle spawns.
...
---------
 ...
 - Update Battleye Filters [Not Tested With DayZ: Isladuala]
 - Update Battleye

Known Bugs
----------

 - If you find any bugs or have any issues related to this server pack, please submit them [here] (https://github.com/Stapo/DayZ-Private-Server-Lite-Isladuala/issues).
